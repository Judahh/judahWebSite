...
var ModelColorEffect_1 = require('./ModelColorEffect');
var ComponentColorEffect = (function () {
    function ComponentColorEffect() {
    }
    ComponentColorEffect.prototype.ngOnInit = function () {
        this.initialization();
    };
    ComponentColorEffect.prototype.initialization = function () {
    };
    __decorate([
        core_1.Input(), 
